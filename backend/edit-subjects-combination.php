                    ...
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6 text-right">
                                <h1>Edit Subject Combination</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="dashboard.html">Home</a></li>
                                    <li class="breadcrumb-item active">Edit Subject Combination</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                                ...
                                <div class="card card-primary">
                                    ...
                                    <form id="quickForm" method="post">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleSelectBorder"> Select Subject:</label>
                                                <select name="subject" class="custom-select form-control-border" id="exampleSelectBorder">
                                                    ...
                                                    if ($query->rowCount() > 0) {
                                                        foreach ($results as $i) { ?>
                                                            <option value="<?php echo htmlentities($i->id) ?>"><?php echo htmlentities($i->SubjectName); ?> </option>
