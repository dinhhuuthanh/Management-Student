                                    ...
                                    <form id="quickForm" method="post">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="subjectname" class="form-control" id="subjectname" placeholder="subjectname">

                                            </div>
                                            <div class="form-group">
                                                <label for="success"> Subject Code:</label>
                                                <input type="text" name="subjectcode" class="form-control" id="subjectcode" placeholder="subjectcode">
