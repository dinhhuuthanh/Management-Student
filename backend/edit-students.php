                                            ...
                                            if ($query->rowCount() > 0) {
                                                foreach ($results as $result) {  ?>
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="studentname" class="form-control" value="<?php echo htmlentities($result->StudentName) ?>" id="studentname" placeholder="studentname">

                                                    </div>
                                                    <div class="form-group">
                                                        <label for="success">New studentname:</label>
                                                        <input type="number" name="studentid" class="form-control" value="<?php echo htmlentities($result->RollId) ?>" id="studentid" placeholder="studentid">

                                                    </div>
                                                    <div class="form-group">
                                                        <label for="success">Confirm studentname:</label>
                                                        <input type="text" name="emailid" class="form-control" value="<?php echo htmlentities($result->StudentEmail) ?>" id="emailid" placeholder="emailid">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            if ($stats == "1") {
                                                            ?>
                                                                <input type="radio" name="status" value="1" required="required" style="margin-left: 10px;margin-right: 10px;" checked>Active <input type="radio" style="margin-left: 10px;margin-right: 10px;" name="status" value="0" required="required">Block
                                                            <?php } ?>
                                                            <?php
                                                            if ($stats == "0") {
                                                            ?>
                                                                <input type="radio" name="status" value="1" style="margin-left: 10px;margin-right: 10px;" required="required">Active <input type="radio" name="status" value="0" required="required" style="margin-left: 10px;margin-right: 10px;" checked>Block
                                                            <?php } ?>
