                                            ...
                                            if ($query->rowCount() > 0) {
                                                foreach ($results as $result) {   ?>
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="classname" class="form-control" value="<?php echo htmlentities($result->ClassName); ?>" id="classname" placeholder="classname">

                                                    </div>
                                                    <div class="form-group">
                                                        <label for="success">New classname:</label>
                                                        <input type="number" name="classnamenumeric" class="form-control" value="<?php echo htmlentities($result->ClassNameNumeric); ?>" id="classnamenumeric" placeholder="classnamenumeric">

                                                    </div>
                                                    <div class="form-group">
                                                        <label for="success">Confirm classname:</label>
                                                        <input type="text" name="section" class="form-control" value="<?php echo htmlentities($result->Section); ?>" id="section" placeholder="section">
